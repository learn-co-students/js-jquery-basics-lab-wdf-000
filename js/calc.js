...
//the function result takes in 3 parameters all validated. the eval function in javascript executes code expressions
//it evaluates the expresstion and then we select the result html with the jquery selector and add the jquery method which allows
//us to manipulate the output but displaying the result in that result tag. we then return the var result.
